...
EXTENSIONS = {
    '3gpp': {'binary', 'audio', '3gpp'},
    'aac': {'binary', 'audio', 'aac'},
    'adoc': {'text', 'asciidoc'},
    ...
    'hbs': {'text', 'handlebars'},
    'hcl': {'text', 'hcl'},
    'heic': {'binary', 'image', 'heic'},
    'heif': {'binary', 'image', 'heif'},
    'hh': {'text', 'header', 'c++'},
    'hpp': {'text', 'header', 'c++'},
    'hrl': {'text', 'erlang'},
    'hs': {'text', 'haskell'},
    ...
    'mov': {'binary', 'video', 'quicktime', 'mov'},
    'movie': {'binary', 'video', 'quicktime', 'movie'},
    'mp3': {'binary', 'audio', 'mp3'},
    'mp4': {'binary', 'audio', 'video', 'mp4'},
    'mpeg': {'binary', 'audio', 'mpeg'},
